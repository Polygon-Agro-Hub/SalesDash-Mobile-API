...
const runSeeds = async () => {
  try {
    ...
    const messageCreateCollectionOfficerCompanyDetails =
      await createCollectionOfficerCompanyDetails();
    console.log(messageCreateCollectionOfficerCompanyDetails);
    const messagecreateCollectionOfficerBankDetails =
      await createCollectionOfficerBankDetails();
    ...
    const messagecreateCollectionCenterOfficer =
      await createCollectionCenterOfficer();
