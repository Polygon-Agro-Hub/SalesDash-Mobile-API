...
// Start server using HTTP server for Socket.io support if not on Vercel
const PORT = process.env.PORT || 3000;
const isVercel = !!process.env.VERCEL;

if (isVercel) {
  console.log("⚡ Running in Vercel Serverless environment. Socket.io and polling intervals disabled.");
  module.exports = app;
} else {
  console.log("🚀 Running in standard node environment. Socket.io and background checkers active.");
